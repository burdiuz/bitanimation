...
export const COMPONENT_NAME = 'bit-color-select';

export class BitColorSelectElement extends HTMLElement {
...
window.customElements.define(COMPONENT_NAME, BitColorSelectElement);
