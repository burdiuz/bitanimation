import { COMPONENT_NAME as FRAME_COMPONENT_NAME } from './bit-frame.js';
...
export const BIT_SWITCH_EVENT = 'bitSwitch';

export const COMPONENT_NAME = 'bit-frame-editor';

export class BitFrameEditorElement extends HTMLElement {
  ...
  get frameElement() {
    return this.root.querySelector(FRAME_COMPONENT_NAME);
  }
...
window.customElements.define(COMPONENT_NAME, BitFrameEditorElement);
